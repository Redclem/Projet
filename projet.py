    ...
    def dessiner(self):
        ...
        for i in range(0, 9):
            ...
            if self.etatTableau[i // 3][i % 3] == CROIX:
                self.canv.create_line((i // 3) * 200 + 10, (i % 3) * 200 + 10, (i // 3) * 200 + 190,
                                      (i % 3) * 200 + 190, width=5)
                self.canv.create_line((i // 3) * 200 + 10, (i % 3) * 200 + 190, (i // 3) * 200 + 190,
                                      (i % 3) * 200 + 10, width=5)

            if self.etatTableau[i // 3][i % 3] == ROND:
                self.canv.create_oval((i // 3) * 200 + 10, (i % 3) * 200 + 10, (i // 3) * 200 + 190,
                                      (i % 3) * 200 + 190, width=5)
